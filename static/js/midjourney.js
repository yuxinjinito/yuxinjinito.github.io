(function () {
  ...
  var i18n = {
    en: {
      ...
      descriptions: {
        ...
        34: 'Tiny people scrambling beneath a giant cat\'s paws — the same ultra-realistic prompt, with different compositional choices.',
        ...
        41: 'A cat in a stock exchange with green-lit negative trends — a variant of the same prompt.',
        ...
        46: 'The most minimal prompt possible: "a cat." — and Midjourney delivers.',
        ...
        74: 'A girl, Kyoto Animation style — simple and evocative.',
        ...
        79: 'Close-up, heavy snow day — a vast Beijing city landscape in grayscale, a cat flying in the sky, sharp contrast.',
        ...
        92: 'One two three scarecrow — three scarecrows in a golden wheat field, whimsical children\'s book style.',
        93: 'Egyptian pyramid at sunset — minimalist landscape, vast desert, golden hour.',
        94: 'A fairy in pink — bestowing good dreams, Cinema4D style, Kuvshinov, Valdi, Skottie Young.',
        95: 'Shanghai skyline, the Bund at night — neon lights, wet streets, cinematic mood.',
        96: 'Stock chart going up — green candlesticks, minimalist infographic, positive trend.',
        ...
        115: 'A cute cartoon calico cat against a blue brushstroke background.',
        ...
        125: 'Advertising photography: summer sunbeams dancing.',
        121: 'A cute baby Chinese dragon in a suit holding a "Hello" sign and waving.',
        122: 'Two little Chinese kids by the rice fields on a summer night watching fireflies — Al Capp style, cartoon, vivid colors.',
        ...
        126: 'A tiny stick figure girl holding an oversized red ball.',
    ...
    zh: {
      ...
      descriptions: {
        ...
        34: '巨猫脚下仓皇奔逃的微缩人类——与前者相同的超写实提示词，构图有所不同。',
        ...
        59: '许多锦鲤一同游弋——色彩鲜艳、密集风格化的构图，最大风格化参数。',
        60: '新年快乐中国龙画——日式动画风格的绿色龙，暗青与金色，流行艺术风格与多彩自由线条。',
        61: '阳光下米老鼠冰雕比赛——极简雕塑风格，正面视角，高而浅的景深，宫崎骏风格，4K超清。',
        62: '地画中的食铁兽——平安时代风格，金绿配色，宋代美学。',
        ...
        79: '特写，大雪天——灰度的北京城景，一只猫飞在天上，强烈对比。',
        ...
        88: '三格写实漫画：一对幸福的情侣、男孩亲手杀死对他微笑的女孩、男孩跪地虔诚祈祷她能升入天堂。',
        89: '一个心死的男孩——传统中国山水风格，朦胧哥特，毛绒玩偶艺术，光泽反射，宁静面孔。',
        90: '桌前愤怒的猫——儿童绘本风格，异想天开的简约美学，明亮色彩，Clémence Guillemaud 风格。',
        91: '白花与白猫——空灵极简、柔光、细腻插画。',
        92: '一二三，稻草人——金色麦田里的三只稻草人，童书般异想天开。',
        93: '金字塔——日落时分的埃及金字塔，极简沙漠景观，黄金时刻。',
        94: '粉色的妖精——赐予美梦的仙子，Cinema4D 风格，Kuvshinov、Valdi、Skottie Young。',
        95: '上海——外滩夜景、霓虹、湿漉街道倒影，电影感。',
        96: '📈——上涨的股票图，绿色 K 线，极简信息图，向好趋势。',
        97: '空山新雨后——中国山水、雾峰、传统水墨与数字结合，静谧。',
        98: '翡翠眼睛——特写肖像，空灵、莹润、细腻。',
        99: '哥特风姐姐——黑色蕾丝、戏剧光效、维多利亚哥特、幽玄之美。',
        100: '小梦仙——赐予美梦的小精灵，柔和光照，奇趣梦幻。',
        ...
        113: '头上开满芍药的女人。',
        114: '一只彩色鹦鹉担任言语治疗师。',
        115: '可爱的卡通三花猫，蓝色笔触背景——风格参考。',
        116: '透明生态球中的红色世界树发光，腹部长着透明生态球的动漫少女凝视腹部，全身，nightcore，棚拍灯光。',
  ...
  function getRecommendations(currentId, count) {
    ...
    return scored.slice(0, count || 4).map(function (x) { return x.id; });
  }
